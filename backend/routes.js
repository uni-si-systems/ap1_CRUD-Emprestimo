...
import { deleteEmprestimos, devolverEmprestimo, insertEmprestimo, selectEmprestimoID, selectEmprestimos, updateEmprestimo } from './controllers/emprestimos.js';
...
const router = Router();
    ...
    router.put('/devolverEmprestimo/:id', devolverEmprestimo); // Devolver emprestimo  
